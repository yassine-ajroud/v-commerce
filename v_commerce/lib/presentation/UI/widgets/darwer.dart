          ...
          child: Padding(
            ...
            child: Column(children: [
              ListTile(
                ...
                DrawerItem(label: 'Paramètres ', icon: APPSVG.settingsIcon, index: 4, onTap: (){controller.selectDrawerItem(4);}, groupeIndex: controller.groupeValue),
                DrawerItem(label: 'Se déconnecté', icon: APPSVG.logoutIcon, index: 5, onTap: (){controller.selectDrawerItem(5);}, groupeIndex: controller.groupeValue),
